  ...
  if (isActive)
    return (
      <div tw="relative w-[68px] h-[68px]">
        ...
        <div tw="w-[68px] h-[68px] bg-[#8785FF] rounded-full flex items-center justify-center z-20 absolute">
          <Image
            src={'/icon/icon-chat-active.svg'}
            width={30}
            height={30}
    ...
    return (
      <div tw="w-[60px] h-full cursor-pointer mb-2 flex flex-col gap-3 items-center justify-center">
        <span tw="font-bold text-white text-base">Inbox</span>
        <div
